# -*- coding: utf-8 -*-
"""
Created on Sat Nov  3 16:58:09 2018
...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov  3 16:17:24 2018
...
while capture.isOpened():
    ...
    # Create a binary image (white is skin color and rest is black)
    ...
    try:
        ...
        if count_defects ==1:
            ...
            cv2.putText(frame, "SIX", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 0, 255), 2)
        elif count_defects == 6:
            
            cv2.putText(frame, "SEVEN", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 0, 255), 2)
        elif count_defects == 7:
            
            cv2.putText(frame, "EIGHT", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 0, 255), 2)
        elif count_defects == 8:
            cv2.putText(frame, "NINE", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 0, 255), 2)
        elif count_defects == 9:
            cv2.putText(frame, "TEN", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 0, 255), 2)
        else:
            pass
    except:
        pass
